        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenLoaiPhong = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChiTietDichVu", x => new { x.MaDichVu, x.MaKhachHang, x.MaDatPhong });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "KH001", "123456789012", "123 Nguyen Van X, Quan 1, TP.HCM", "khachhang1@example.com", "Nam", "password1", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8770), new DateTime(1992, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "123456789", "Nguyen Van X", "Đang hoạt động" },
                    { "KH002", "987654321098", "456 Tran Thi Y, Quan 2, TP.HCM", "khachhang2@example.com", "Nữ", "password2", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8773), new DateTime(1995, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "987654321", "Tran Thi Y", "Đang hoạt động" },
                    { "KH003", "111223344055", "789 Le Van Z, Quan 3, TP.HCM", "khachhang3@example.com", "Nam", "password3", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8775), new DateTime(1988, 10, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "111223344", "Le Van Z", "Đang hoạt động" },
                    { "KH004", "555666777044", "101 Pham Thi K, Quan 4, TP.HCM", "khachhang4@example.com", "Nữ", "password4", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8777), new DateTime(1990, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "555666777", "Pham Thi K", "Đang hoạt động" },
                    { "KH005", "999888777033", "202 Hoang Van M, Quan 5, TP.HCM", "khachhang5@example.com", "Nam", "password5", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8779), new DateTime(1985, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "999888777", "Hoang Van M", "Ngừng hoạt động" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "LP0001", 100000, 50000, 20000, 1, 2, "Phòng Đơn" },
                    { "LP0002", 150000, 80000, 25000, 2, 3, "Phòng Đôi" },
                    { "LP0003", 200000, 120000, 30000, 4, 2, "Phòng Gia Đình" },
                    { "LP0004", 250000, 150000, 35000, 3, 1, "Phòng Suite" },
                    { "LP0005", 300000, 200000, 40000, 2, 2, "Phòng VIP" },
                    { "LP0006", 1000000, 500000, 60000, 4, 4, "Phòng 3 Deluxe" },
                    { "LP0007", 1000000, 600000, 70000, 4, 4, "Phòng Suite Grand" },
                    { "LP0008", 1000000, 700000, 60000, 3, 4, "Phòng Suite Executive" },
                    { "LP0009", 1300000, 900000, 80000, 7, 5, "Phòng Suite Royal" },
                    { "LP0010", 1200000, 600000, 60000, 2, 2, "Deluxe King Room" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "NV001", "UploadImage\\profileStaff.jpg", "123456789012", "Quản lý", "123 Nguyen Van A, Quan 1, TP.HCM", "nhanvien1@example.com", "Nam", "password1", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8656), new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8664), "123456789", "Nguyen Van A", "Đang hoạt động" },
                    { "NV002", "UploadImage\\profileStaff2.jpg", "987654321098", "Nhân viên", "456 Tran Thi B, Quan 2, TP.HCM", "nhanvien2@example.com", "Nữ", "password2", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8673), new DateTime(1995, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8674), "987654321", "Tran Thi B", "Đang hoạt động" },
                    { "NV003", "UploadImage\\profileStaff3.jpg", "111223344055", "Nhân viên", "789 Le Van C, Quan 3, TP.HCM", "nhanvien3@example.com", "Nam", "password3", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8676), new DateTime(1985, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8677), "111223344", "Le Van C", "Nghỉ việc" },
                    { "NV004", "UploadImage\\profileStaff4.jpg", "555666777044", "Quản lý", "101 Pham Thi D, Quan 4, TP.HCM", "nhanvien4@example.com", "Nữ", "password4", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8679), new DateTime(1988, 8, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2018, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8680), "555666777", "Pham Thi D", "Đang hoạt động" },
                    { "NV005", "UploadImage\\profileStaff5.webp", "999888777033", "Nhân viên", "202 Hoang Van E, Quan 5, TP.HCM", "nhanvien5@example.com", "Nam", "password5", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8682), new DateTime(1980, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2019, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8682), "999888777", "Hoang Van E", "Đang hoạt động" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "VT001", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8929), "Nội Thất Minh Nhật", "Giường", "Đang hoạt động" },
                    { "VT002", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8930), "Cửa Hàng Đồ Gỗ Minh Quốc", "Bàn", "Đang hoạt động" },
                    { "VT003", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8931), "Cửa Hàng Đồ Gỗ Minh Quốc", "Ghế", "Đang hoạt động" },
                    { "VT004", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8932), "Đèn trang thí Lan Anh", "Đèn ngủ", "Ngưng hoạt động" },
                    { "VT005", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8933), "Rèm xinh Bmt", "Rèm", "Đang hoạt động" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "P00001", "LP0001", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8816), "Đang hoạt động" },
                    { "P00002", "LP0002", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8819), "Đang hoạt động" },
                    { "P00003", "LP0003", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8820), "Đang hoạt động" },
                    { "P00004", "LP0004", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8821), "Đang hoạt động" },
                    { "P00005", "LP0005", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8822), "Đang hoạt động" },
                    { "P00006", "LP0006", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8823), "Đang hoạt động" },
                    { "P00007", "LP0007", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8824), "Đang hoạt động" },
                    { "P00008", "LP0008", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8824), "Đang hoạt động" },
                    { "P00009", "LP0001", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8825), "Đang hoạt động" },
                    { "P00010", "LP0002", new DateTime(2023, 12, 17, 17, 44, 10, 96, DateTimeKind.Local).AddTicks(8826), "Đang hoạt động" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 16, "P00006", "Phong3Deluxe1.1.JPG" },
                    { 17, "P00006", "Phong3Deluxe1.2.JPG" },
                    { 18, "P00006", "Phong3Deluxe1.3.JPG" },
                    { 19, "P00006", "Phong3Deluxe1.4.JPG" },
                    { 20, "P00006", "Phong3Deluxe1.5.JPG" },
                    { 21, "P00007", "PhongSuiteGrand1.1.JPG" },
                    { 22, "P00007", "PhongSuiteGrand1.2.JPG" },
                    { 23, "P00007", "PhongSuiteGrand1.3.JPG" },
                    { 24, "P00007", "PhongSuiteGrand1.4.JPG" },
                    { 25, "P00007", "PhongSuiteGrand1.5.JPG" },
                    { 26, "P00007", "PhongSuiteGrand1.6.JPG" },
                    { 27, "P00008", "PhongSuiteExecutive1.3.JPG" },
                    { 28, "P00008", "PhongSuiteExecutive1.1.JPG" },
                    { 29, "P00008", "PhongSuiteExecutive1.2.JPG" },
                    { 30, "P00008", "PhongSuiteExecutive1.4.JPG" },
                    { 31, "P00008", "PhongSuiteExecutive1.5.JPG" },
                    { 32, "P00008", "PhongSuite1.3.webp" },
                    { 33, "P00008", "PhongSuite1.2.JPG" },
                    { 34, "P00008", "PhongSuite1.4.JPG" },
                    { 35, "P00008", "PhongSuite1.1.JPG" },
                    { 36, "P00009", "PhongDoi1.2.JPG" },
                    { 37, "P00009", "PhongDoi1.1.JPG" },
                    { 38, "P00009", "PhongDoi1.3.JPG" },
                    { 39, "P00009", "PhongDoi1.4.JPG" },
                    { 40, "P00010", "PhongDon1.5.JPG" },
                    { 41, "P00010", "PhongDon1.1.JPG" },
                    { 42, "P00010", "PhongDon1.2.JPG" },
                    { 43, "P00010", "PhongDon1.3.JPG" },
                    { 44, "P00010", "PhongDon1.4.JPG" }
                });
